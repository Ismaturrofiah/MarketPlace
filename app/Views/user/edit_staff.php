    ...
    <div class="row">
        <div class="col-xl-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/staff/ubah/<?= $barang['id_barang']; ?>" method="POST" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama barang" value="<?= $barang['nama']; ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="inputState" class="form-control" name="jenis">
                                            <option selected value="<?= $barang['jenis']; ?>">Pilih Jenis Barang</option>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="harga" name="harga" class="form-control" placeholder="Stok barang" value="<?= $barang['harga']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="file-input">
                                        <input type="textarea" id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan" value="<?= $barang['keterangan']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div style="display: flex; margin-left:2%" class="buton">
                                        ...
                                        <button style="margin-left: 2%;" type="submit" class="btn btn-primary mb-3" name="submit">Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
